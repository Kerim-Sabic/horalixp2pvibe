# The Horalix P2P Goals

Horalix P2P is a **continuous file synchronization program**. It synchronizes
...
> expect Horalix P2P to be resistant against well equipped state level
> attackers. We will, however, do our best. Note also that this is different
> from anonymity which is not, currently, a goal.

### 3. Easy to Use

Horalix P2P should be approachable, understandable, and inclusive.

> Complex concepts and maths form the base of Horalix P2P's functionality.
> This should nonetheless be abstracted or hidden to a degree where
> Horalix P2P is usable by the general public.
...
Horalix P2P should run on every common computer. We are mindful that the
...
> Horalix P2P to run smoothly on these devices.

### 6. For Individuals

Horalix P2P is primarily about empowering the individual user with safe,
...
> matter. It is understood that there are aspects of Horalix P2P that are
> suboptimal or even in opposition with the goals above. However, we
> continuously strive to align Horalix P2P more and more with these goals.
