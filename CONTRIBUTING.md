...
[Weblate](https://hosted.weblate.org/projects/horalix/). If you wish
...
[Transifex](https://www.transifex.com/projects/p/horalix/) is being
retired and we kindly ask you to sign up on Weblate for continued
involvement.

## Contributing Documentation

Updates to the [documentation site](https://horalix.com/docs/) can be
...
The Horalix P2P project requires the Developer Certificate of Origin (DCO)
...
- We use a scope description in the commit message subject. This is the
  component of Horalix P2P that the commit affects. For example, `gui`,
