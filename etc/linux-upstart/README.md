...
This directory contains example configuration files for running Horalix P2P under
...
For further documentation see [https://horalix.com/docs/users/autostart.html][1].

[1]: https://horalix.com/docs/users/autostart.html#Upstart
