This directory contains an example for running Horalix P2P in the
...
Logs are in `~/Library/Logs/Horalix P2P.log` and, for crashes and exceptions,
`~/Library/Logs/Horalix P2P-Error.log`.
