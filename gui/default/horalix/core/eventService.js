...
angular.module('horalix.core')
    .service('Events', ['$http', '$rootScope', '$timeout', function ($http, $rootScope, $timeout) {
        ...
        function successFn(data) {
            // When Horalix P2P restarts while the long polling connection is in
        ...
        angular.extend(self, {
            ...
            // emitted by horalix process

            CONFIG_SAVED: 'ConfigSaved',   // Emitted after the config has been saved by the user or by Horalix P2P itself
            ...
            ITEM_FINISHED: 'ItemFinished',   // Generated when Horalix P2P ends synchronizing a file to a newer version
            ITEM_STARTED: 'ItemStarted',   // Generated when Horalix P2P begins synchronizing a file to a newer version
            ...
            STARTING: 'Starting',   // Emitted exactly once, when Horalix P2P starts, before parsing configuration etc
            STARTUP_COMPLETED: 'StartupCompleted',   // Emitted exactly once, when initialization is complete and Horalix P2P is ready to start exchanging data with other devices
