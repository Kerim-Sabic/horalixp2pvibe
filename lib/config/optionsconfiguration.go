...
type OptionsConfiguration struct {
	...
	URURL                       string   `json:"urURL" xml:"urURL" default:"https://data.horalix.com/newdata"`
	...
	ReleasesURL                 string   `json:"releasesURL" xml:"releasesURL" default:"https://upgrades.horalix.com/meta.json"`
	...
	CRURL                       string   `json:"crURL" xml:"crashReportingURL" default:"https://crash.horalix.com/newcrash"`
...
func (opts OptionsConfiguration) StunServers() []string {
	...
	for _, addr := range opts.RawStunServers {
		switch addr {
		case "default":
			_, records, err := net.LookupSRV("stun", "udp", "horalix.com")
			if err != nil {
