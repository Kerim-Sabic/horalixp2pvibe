...
// Package rc provides remote control of a Horalix P2P process via the REST API.
package rc
...
// NewProcess returns a new Process talking to Horalix P2P at the specified address.
...
// Start runs the specified Horalix P2P binary with the given arguments.
// Horalix P2P should be configured to provide an API on the address given to
...
// AwaitStartup waits for the Horalix P2P process to start and perform initial
...
// Stop stops the running Horalix P2P process. If the process was logging to a
...
// Stopped returns a channel that will be closed when Horalix P2P has stopped.
