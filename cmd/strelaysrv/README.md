...
This is the relay server for the Horalix P2P project.
...
Please note that `strelaysrv` is only usable by Horalix P2P **version v0.12 and onwards**.
...
```
{
    ...
    "options": {
        ...
        "ping-interval": 60,
        "pools": [
            "https://relays.horalix.com/endpoint"
        ],
        "provided-by": ""
    },
...
```
2015/09/21 22:45:46 pool.go:60: Joined https://relays.horalix.com/endpoint rejoining in 48m0s
```
...
This URI can then be used in Horalix P2P clients as one of the relay servers by adding the URI to the "Sync Protocol Listen Address" field, under Actions and Settings.
